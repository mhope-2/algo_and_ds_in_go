...
// Heaps are part of the container/heap package in Go. 
...
// The heap data structure was proposed by J.W.J. Williams in 1964 for a heap sorting algorithm. 
...
// IntegerHeap receiver method - gets the length of integerHeap
func (iheap IntegerHeap) Len() int {
	return len(iheap)
}

// IntegerHeap receiver method - checks if element of i index is less than j index
...
func (iheap *IntegerHeap) Push(iheapintf interface{}){
	*iheap = append(*iheap, iheapintf.(int))
}
